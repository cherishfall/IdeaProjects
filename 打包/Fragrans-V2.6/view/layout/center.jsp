...
<div id="layout_center_tabs"  style="overflow: hidden;">
	<div title="首页" data-options="href:'${pageContext.request.contextPath}/homeStat/portal.do'"></div>
</div>
<div id="layout_center_tabsMenu" style="width: 120px;display:none;">
	<div type="refresh" style="border:0px">刷新</div>
	<div class="menu-sep"></div>
	<div type="close" style="border:0px">关闭</div>
	<div type="closeOther" style="border:0px">关闭其他</div>
	<div type="closeAll" style="border:0px">关闭所有</div>
</div>