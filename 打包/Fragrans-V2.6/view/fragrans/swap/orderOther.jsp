...
<html>
  <head>
   <%@include file="/view/inc.jsp" %>
	...
	<!-- Search panel start -->
 	 ...
 	 <form id="searchForm">
 	 	<p class="ui-fields">
		   ...
		   <label class="ui-label">订单种类:</label><mytag:dictionary name="orderType" id="orderType" codeType="PAY_ACCOUNT_TYPE" isDefaultLine="1" dataOptions="required:false"/>
	...
	<div id="exportOrderOtherList" class="easyui-dialog" title="导出账单"
		data-options="closed:true,iconCls:'icon-save',modal:true"
		style="width: 350px; height: 260px;" singleSelect:false>
		<form id="exportOrderOtherListForm" class="ui-form" method="post">
  	...
  	<!-- js -->
	<script type="text/javascript" src="<%=basePath%>/assets/js/business/fragrans/swap/orderOther.js"></script>
  </body>
</html>
