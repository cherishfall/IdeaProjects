   ...
   <%@include file="/view/inc.jsp" %>
	...
	<!-- Search panel start -->
     ...
     <div id="edit-win" class="easyui-dialog" title="编辑" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:300px;">  
							...
							<td> 
								 <input class="easyui-validatebox" type="text" name="totalOrderCount" missingMessage="请输入总交易单数，支付宝原始账单数量"
			                		    data-options="required:true,validType:'length[1,10]'" />
				   			     	 ...
				   			     	 <tr>
							<td style="text-align: right;"> 总收入额:</td>
							<td> 
								 <input class="easyui-validatebox" type="text" name="totalIncomeCount" missingMessage="请输入总收入额"
			                		    data-options="required:true,validType:'length[1,8]'" />
							</td>					 
						</tr>
				   			     	 <tr>
							<td style="text-align: right;"> 总支出额:</td>
							<td> 
								 <input class="easyui-validatebox" type="text" name="totalOutcomeCount" missingMessage="请输入总支出额"
			                		    data-options="required:true,validType:'length[1,8]'" />
							</td>					 
						</tr>
				   			     	 <tr>
  	...
  	<!-- js -->
	<script type="text/javascript" src="<%=basePath%>/assets/js/business/fragrans/rca/alipayCount.js"></script>
  </body>
</html>
